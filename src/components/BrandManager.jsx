...
const BrandManager = () => {
    ...
    const fetchBrands = async () => {
        ...
        try {
          ...
          // API yanıtının doğru formatını kontrol edin, data özelliği içindeki veriyi alın
          setBrands(response.data.data || response.data || []);
        } catch (error) {
          console.error("Markalar yüklenirken hata:", error);
          toast.error("Markalar yüklenemedi!");
          // Hata durumunda da boş dizi atayın
          setBrands([]);
        } finally {
          setLoading(false);
        }
    ...
    // Filtreleme işlemi yapmadan önce brands'in dizi olduğundan emin olun
