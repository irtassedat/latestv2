...
import { FiEdit2, FiTrash2, FiPlus, FiMapPin, FiPhone, FiMail, FiHome, FiInfo, FiSettings, FiPackage, FiLayers } from "react-icons/fi";
                                ...
                                <div className="flex-1">
                                  <div className="flex justify-between">
                                    ...
                                    <span className="text-xs px-2 py-0.5 bg-purple-100 text-purple-800 rounded-full">
                                      {integration.type === 'delivery' && 'Teslimat'}
                                      {integration.type === 'payment' && 'Ödeme'}
                                      {integration.type === 'order' && 'Sipariş'}
                                      {integration.type === 'menu' && 'Menü'}
                                      {integration.type === 'other' && 'Diğer'}
                                    </span>
                                  </div>
